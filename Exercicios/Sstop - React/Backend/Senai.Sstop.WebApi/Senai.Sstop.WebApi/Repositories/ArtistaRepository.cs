...
namespace Senai.Sstop.WebApi.Repositories
{
    ...
    {
        //private string StringConexao = "Data Source=localhost; initial catalog=Sstop;Integrated Security=true";
        private string StringConexao = "Data Source =.\\SqlExpress; Initial Catalog = Sstop; User Id = sa; Pwd=132";
